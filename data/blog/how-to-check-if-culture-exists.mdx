---
title: How to check if culture exists in .NET?
date: '2024-10-08'
draft: false
...
Let's compare the performance of both methods. I will use the `BenchmarkDotNet` library to measure the performance of both methods. The benchmark will be run on the .NET 8.0 platform.

...
>
> Source: https://world.optimizely.com/blogs/grzegorz-wiechec/dates/2017/9/sticky-view-mode/

It can just be set as a property `EnableStickyView` under UI descriptor. You may read more in the linked blog post.
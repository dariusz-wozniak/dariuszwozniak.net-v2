...
> Note
>
> Like other content types, media types must first be defined in the content model, to use the built-in functionality for assets. If a media type is not defined on the website, file upload or drag and drop will not work.
...
![Asset Folder](/static/images/blog/optimizely/assets.png)

You can create an asset folder in the CMS UI, but you can also create it programmatically. In this blog post, I will show you how to create an asset folder programmatically.
...
![Asset Folder](/static/images/blog/optimizely/assets-root.png)

...
summary: Optimizely Search & Navigation (a.k.a. EPiServer Find) ia a powerful engine but, as being a black box, it might be difficult to diagnose its behavior when things go wrong. This article describes how to make a deep dive into the search engine and get the insights about the underlying query.
---
...
Example of the query (using the Foundation project):
...
```json
{
	...
	"hits": {
		...
		"hits": [
			{
				"_index": "dwozniakfls_founddddddd-en",

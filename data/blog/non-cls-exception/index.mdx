...
- This post does not have any practical value. It's just a curiosity that I wanted to check. I don't think that anyone is using the C# version lower than 2.0 and non-CLS-compliant exceptions.
